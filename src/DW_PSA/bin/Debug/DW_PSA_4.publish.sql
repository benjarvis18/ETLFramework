...
GO
PRINT N'Altering [psa].[Load_AdventureWorks_Sales_SalesOrderDetail]...';


GO
ALTER PROCEDURE psa.[Load_AdventureWorks_Sales_SalesOrderDetail]
AS
BEGIN
	BEGIN TRY
		BEGIN TRAN
...
END
GO
PRINT N'Altering [psa].[Load_AdventureWorks_Sales_SalesOrderHeader]...';
...
ALTER PROCEDURE psa.[Load_AdventureWorks_Sales_SalesOrderHeader]
AS
BEGIN
	BEGIN TRY
		BEGIN TRAN
