...
GO
PRINT N'Creating [Staging].[Extractions]...';
...
CREATE TABLE [Staging].[Extractions] (
    ...
    CONSTRAINT [PK_Staging_Extractions] PRIMARY KEY CLUSTERED ([ExtractionId] ASC)
);


GO
PRINT N'Creating [Staging].[Connections]...';
...
CREATE TABLE [Staging].[Connections] (
    ...
    CONSTRAINT [PK_Staging_Connections] PRIMARY KEY CLUSTERED ([ConnectionId] ASC),
    CONSTRAINT [UQ_Staging_Connections_ConnectionName] UNIQUE NONCLUSTERED ([ConnectionName] ASC)
);
...
GO
PRINT N'Creating [Staging].[GetConnections]...';
