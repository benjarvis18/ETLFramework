...
GO
PRINT N'Creating [PSA].[Connections]...';
...
CREATE TABLE [PSA].[Connections] (
    ...
    CONSTRAINT [PK_PSA_Connections] PRIMARY KEY CLUSTERED ([ConnectionId] ASC),
    CONSTRAINT [UQ_PSA_Connections_ConnectionName] UNIQUE NONCLUSTERED ([ConnectionName] ASC)
);


GO
TRUNCATE TABLE Staging.Extractions
TRUNCATE TABLE Staging.Connections

-- Connections
INSERT INTO Staging.Connections ( ConnectionName, ConnectionString )
